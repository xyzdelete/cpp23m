...
> ⚠️ **Warning:** YOu will need the launch.json file that you set up earlier in other projects that we create as we go through the course. Make sure you copy it over in the root of any new project that you create. This will make it easier to build and debug your programs.
